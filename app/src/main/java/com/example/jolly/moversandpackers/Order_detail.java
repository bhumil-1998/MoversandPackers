...
public class Order_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //id=intent.getIntExtra("shifting_id",0);
        name_txt.setText(intent.getStringExtra("transporter_name"));
        ...
        lv = (ListView) findViewById(R.id.order_detail_list);
        //   MyAdapterquantity adapter = new MyAdapterquantity(getApplicationContext(), item, quantity);
       // lv.setAdapter(adapter);
    }
    public class orderdetails extends AsyncTask<String,String,String>{
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Order_detail.this);
            ...
            if(json!=null){
                try {
                    ...
                    if (status==1) {
                        ...
                        Toast.makeText(Order_detail.this, ""+message, Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(Order_detail.this,Request_customer.class);
                ...
                Toast.makeText(Order_detail.this, "Cannot get json from server", Toast.LENGTH_SHORT).show();
            }
    ...
    class MyAdapter  extends ArrayAdapter {
        ...
        String item_str="Item Names";
        String qty_str="Quantity";
